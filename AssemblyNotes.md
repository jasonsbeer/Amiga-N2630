...
4) Interactive BOM can be found [here](/N2630-REV30-ibom.html). Download the file and open it your browser.
5) I recommend you do not install the 68882 (or socket) until everything is known to work. The through holes here are very convienient for connecting probes in the event troublshooting is required.
